...
export const PomodoroPage: React.FC = () => {
  return (
    <div className="p-6 h-full flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-base font-bold text-foreground">番茄专注</h1>
      <p className="text-sm text-muted-foreground mt-1 mb-8 max-w-sm">
        保持 25 分钟沉浸式高效工作，随后休息 5 分钟
      </p>

      <div className="text-6xl font-mono font-bold tracking-tight text-foreground mb-8">
        25:00
      </div>
